package com.example.bai_tap_buoi_11.config;
...
public class HibernateConfig {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=BTVNBuoi9;encrypt=true;trustServerCertificate=true;");
