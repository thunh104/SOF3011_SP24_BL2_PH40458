package com.example.PH40458_LAB5_6_0406.config;
...
public class HibernateConfig {
    ...
    static {
        ...
        conf.addAnnotatedClass(SanPham.class);//Đăng kí với hibernate để mapped đối tượng, bao nhiêu class bấy nhiêu đối tượng
