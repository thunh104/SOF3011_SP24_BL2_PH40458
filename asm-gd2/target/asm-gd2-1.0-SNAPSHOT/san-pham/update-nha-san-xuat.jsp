...
<div class="container text-content ms-5 mt-3">
    <form action="/nha-san-xuat/update?id=${updateNSX.id}" method="post">
        <div class="mb-3 col-6">
            <label for="inputMa" class="form-label">Mã màu sắc</label>
            <input type="text" class="form-control" id="inputMa" name="ma" value="${updateNSX.ma}">
        </div>
        <div class="mb-3 col-6">
            <label for="inputTen" class="form-label">Tên màu sắc</label>
            <input type="text" class="form-control" id="inputTen" name="ten" value="${updateNSX.ten}">
        </div>
