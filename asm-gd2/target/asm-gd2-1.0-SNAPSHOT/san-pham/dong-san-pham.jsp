...
<div class="container">
    ...
    <div class="row col-12 mt-3">
        <div class="col-10 fs-4 fw-semibold">Dòng sản phẩm</div><hr>
    </div>
    <form action="/dong-san-pham/add" method="post">
        <div class="row col-12">
            <div class="mb-3 col-6">
                <label for="inputMa" class="form-label">Mã dòng SP</label>
                <input type="text" class="form-control" id="inputMa" name="ma" value="${detailDSP.ma}">
            </div>
            <div class="mb-3 col-6">
                <label for="inputTen" class="form-label">Tên dòng SP</label>
                <input type="text" class="form-control" id="inputTen" name="ten" value="${detailDSP.ten}">
            </div>
        </div>
    ...
    <table class="table me-3">
        ...
        <c:forEach items="${dongSP}" var="dsp">
            <tr>
                ...
                <td>${dsp.ten}</td>
                <td>
                    <a href="/dong-san-pham/detail?id=${dsp.id}"><i class="bi bi-eye me-2"></i></a>
                    <a href="/dong-san-pham/view-update?id=${dsp.id}"><i class="bi bi-pencil-square ms-4 me-4"></i></a>
                    <a href="/dong-san-pham/remove?id=${dsp.id}"><i class="bi bi-trash3 ms-2"></i></a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
