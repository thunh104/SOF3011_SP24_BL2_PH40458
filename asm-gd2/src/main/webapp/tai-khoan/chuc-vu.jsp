...
<div class="container">
    ...
    <div class="row col-12 mt-3">
        <div class="col-10 fs-4 fw-semibold">Chức vụ</div>
        <hr>
    </div>
    <form action="/chuc-vu/add" method="post">
        <div class="row col-12">
            <div class="mb-3 col-6">
                ...
                <input type="text" class="form-control" id="inputMa" name="ma" value="${detailCV.ma}">
            </div>
            <div class="mb-3 col-6">
                <label for="inputTen" class="form-label">Tên chức vụ</label>
                <input type="text" class="form-control" id="inputTen" name="ten" value="${detailCV.ten}">
            </div>
        </div>
    ...
    <table class="table me-3">
        ...
        <c:forEach items="${chucVu}" var="cv">
            <tr>
                ...
                <td>${cv.ten}</td>
                <td>
                    <a href="/chuc-vu/detail?id=${cv.id}"><i class="bi bi-eye me-2"></i></a>
                    <a href="/chuc-vu/view-update?id=${cv.id}"><i class="bi bi-pencil-square ms-4 me-4"></i></a>
                    <a href="/chuc-vu/remove?id=${cv.id}"><i class="bi bi-trash3 ms-2"></i></a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
